...
const Contact = () => {
  ...
  return (
    <div className='bg-[#2D547D] mt-14 md:px-20 px-8 pt-20 pb-36'>
    <div className='lg:text-[32px] md:text-[28px] text-[24px] text-white flex lg:flex-row md:flex-col flex-col items-center  justify-center mb-10  lg:gap-5 md:gap-0 gap-0 w-full'>
