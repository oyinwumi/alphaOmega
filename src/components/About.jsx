  ...
  return ( 
    <section className="bg-[ #FFFFFF] text-[#2F2F2F]  md:px-20 px-8 pb-10">
        ...
        <div className="flex flex-col  gap-10 pt-20 text-[#2D547D]">
           ...
           <img src={Aoc} alt="" className="lg:w-[700px] w-[80%] md:h-[700px] h-96 object-cover border rounded-3xl" />
           ...
           <img src={Silverback} alt="" className="lg:w-[700px] w-[80%] md:h-[700px] h-96  object-cover border rounded-3xl" />
        
           </div>
           <div className="flex">
           <img src={Aoc1} alt="" className="lg:w-[700px] w-[80%] md:h-[700px] h-96  object-cover border rounded-3xl " />
          <div className="lg:ml-32 ml-10 md:mt-56 mt-10">
